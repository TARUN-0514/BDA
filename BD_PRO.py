...
def blood_group():
        print("\n\nCHOOSE NO. ACCORDING TO YOUR BLOOD GROUP : ")
        choice1=input("\n1.A+ \t2.B+ \t3.O+ \t4.AB+ \t5.A- \t6.B- \t7.O- \t8.AB-\n")
        print("Number Chosen is: " + choice1)
blood_group()

print("GO THROUGH THE FOLLOWING QUTIONER TO COMPLETE THE APPLICATION PROCESS :(Answer in YES or NO) ")
